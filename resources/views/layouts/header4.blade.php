		...
		<div class="header pt-0 py-lg-4 mr-0">
			...
			<div class="container">
				...
				<div class="row header-section">
					...
					<!--<button class="btn ml-3 head-btn-res"><a href="tel:+97143337876" class="header-phone"><img class="mr-2" src="{{ asset('front2/images/phone.webp') }}" alt="phone" onerror="this.onerror=null; this.src='/public/front2/images/phone.png'">+971 4 333 7876</a></button>-->
...
<i class="fa fa-phone my-float"></i>
		...
		<div class="banner position-relative">
				...
				<div class="row">
					...
					<div class="col-lg-5">
						...
						<div class="banner-form position-relative">
							...
							<p class="h3 text-uppercase font-poiret" style="font-size: 36px;">CAR CASHING SERVICE</p>
            ...
            <select class="form-control" style="width: 100%;" id="brand_val" name="brand_name">
               ...
               <option value="{{ $brand->name }}" style="padding: 0px;">{{ $brand->name }}</option>
                ...
                <select class="modl-model form-control" id="fetched_model" style="width: 100%;" name="model_name" selected>
                ...
                <option value="" selected disabled="disabled">Select Model</option>
							...
							<div class="form-group w-fift car_year">
								...
								<div class="dropdown">
								  ...
								  <select class="modl-year form-control" style="width: 100%;" id="year" name="year">
           ...
           <option value="2020" style="padding: 0px;">2020</option>
			...
			<div class="ajax-loader" style="display:none;position: absolute;width: 100%;height: 100%;z-index: 11;background: rgba(238, 238, 238, 0.4);top:0px;left:0px;"><div class="loader-inner" style="display: flex;align-items: center;position: relative;height: 100%;justify-content: center;">
				...
				<img src="{{ asset('front/images/front-loader.svg') }}" alt="" style="width:35px;"></div>
...
<!--                     <li><a href="{{ url('sell-acura') }}">We Cash Acura</a></li>-->

<!--                     <li><a href="{{ url('sell-bugatti') }}">We Cash Bugatti</a></li>-->

<!--                     <li><a href="{{ url('sell-ferrari') }}">We Cash Ferrari</a></li>-->

<!--                     <li><a href="{{ url('sell-infiniti') }}">We Cash Infiniti</a></li>-->

<!--                     <li><a href="{{ url('sell-land-rover') }}">We Cash Land Rover</a></li>-->

<!--                     <li><a href="{{ url('sell-mazda') }}">We Cash Mazda</a></li>-->

<!--                     <li><a href="{{ url('sell-opel') }}">We Cash Opel</a></li>-->

<!--                     <li><a href="{{ url('sell-subaru') }}">We Cash Subaru</a></li>-->
...
<!--                     <li><a href="{{ url('sell-my-car/alfa-romeo') }}">We Cash Alfa Romeo</a></li>-->

<!--                     <li><a href="#" class="non-click">We Cash Buick</a></li>-->

<!--                     <li><a href="{{ url('sell-fiat') }}">We Cash Fiat</a></li>-->

<!--                     <li><a href="{{ url('sell-jaguar') }}">We Cash Jaguar</a></li>-->

<!--                     <li><a href="{{ url('sell-lexus') }}">We Cash Lexus</a></li>-->

<!--                     <li><a href="{{ url('sell-mcLaren') }}">We Cash McLaren</a></li>-->

<!--                     <li><a href="{{ url('sell-peugeot') }}">We Cash Peugeot</a></li>-->

<!--                     <li><a href="{{ url('sell-suzuki') }}">We Cash Suzuki</a></li>-->
...
<!--                     <li><a href="{{ url('sell-aston-martin') }}">We Cash Aston Martin</a></li>-->

<!--                     <li><a href="{{ url('sell-cadillac') }}">We Cash Cadillac</a></li>-->

<!--                     <li><a href="{{ url('sell-ford') }}">We Cash Ford</a></li>-->

<!--                     <li><a href="{{ url('sell-jeep') }}">We Cash Jeep</a></li>-->

<!--                     <li><a href="{{ url('sell-lincoln') }}">We Cash Lincoln</a></li>-->

<!--                     <li><a href="{{ url('sell-mercedes-benz') }}">We Cash Mercedes-Benz</a></li>-->

<!--                     <li><a href="{{ url('sell-pontiac') }}">We Cash Pontiac</a></li>-->

<!--                     <li><a href="{{ url('sell-tesla') }}">We Cash Tesla</a></li>-->
...
<!--                     <li><a href="{{ url('sell-audi') }}">We Cash Audi</a></li>-->

<!--                     <li><a href="{{ url('sell-chevrolet') }}">We Cash Chevrolet</a></li>-->

<!--                     <li><a href="{{ url('sell-gmc') }}">We Cash GMC</a></li>-->

<!--                     <li><a href="{{ url('sell-kia') }}">We Cash Kia</a></li>-->

<!--                     <li><a href="{{ url('sell-lotus') }}">We Cash Lotus</a></li>-->

<!--                     <li><a href="{{ url('sell-mini') }}">We Cash Mini</a></li>-->

<!--                     <li><a href="{{ url('sell-porsche') }}">We Cash Porsche</a></li>-->

<!--                     <li><a href="{{ url('sell-toyota') }}">We Cash Toyota</a></li>-->
...
<!--                     <li><a href="{{ url('sell-bentley') }}">We Cash Bentley</a></li>-->

<!--                     <li><a href="{{ url('sell-chrysler') }}">We Cash Chrysler</a></li>-->

<!--                     <li><a href="{{ url('sell-honda') }}">We Cash Honda</a></li>-->

<!--                     <li><a href="#" class="non-click">We Cash Koenigsegg</a></li>-->

<!--                     <li><a href="{{ url('sell-maserati') }}">We Cash Maserati</a></li>-->

<!--                     <li><a href="{{ url('sell-mitsubishi') }}">We Cash Mitsubishi</a></li>-->

<!--                     <li><a href="{{ url('sell-renault') }}">We Cash Renault</a></li>-->

<!--                     <li><a href="{{ url('sell-volkswagen') }}">We Cash Volkswagen</a></li>-->
...
<!--                     <li><a href="{{ url('sell-bmw') }}">We Cash BMW</a></li>-->

<!--                     <li><a href="{{ url('sell-dodge') }}">We Cash Dodge</a></li>-->

<!--                     <li><a href="{{ url('sell-hyundai') }}">We Cash Hyundai</a></li>-->

<!--                     <li><a href="{{ url('sell-lamborghini') }}">We Cash Lamborghini</a></li>-->

<!--                     <li><a href="{{ url('sell-maybach') }}">We Cash Maybach</a></li>-->

<!--                     <li><a href="{{ url('sell-nissan') }}">We Cash Nissan</a></li>-->

<!--                     <li><a href="{{ url('sell-rolls-royce') }}">We Cash Rolls Royce</a></li>-->

<!--                     <li><a href="{{ url('sell-volvo') }}">We Cash Volvo</a></li>-->
