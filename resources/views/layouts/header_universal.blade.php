...
<head>
  ...
  @endif
    ...
    <style>
        ...
        .peopletrustsec .display-inline-block.ml-2 {
                width: 65%;
        }
        .footer {
            background: #FCF5F2;
        ...
        {
            background: #FFFFFF;
            border: 2.01369px solid #FFD0C9;
            border-radius: 22.519px;
            padding: 40px;
            min-height: 238px;
        }
        ...
        .how_does_work_section .work_box p
        {
            font-family: 'Roboto';
            font-style: normal;
            font-weight: 400;
    ...
    .auto-fr {
        ...
        .cmninrpgebnr.banner:before, .peopletrustsec .process-Title:before {
            display: none
        }
        ...
        .wekeepcontentsec .container .content{
            padding: 40px 50px;
            background: #FFFFFF;
            border: 2px solid #FFD0C9;
            border-radius: 22.3659px;
        ...
        .ourgurantee_section .col-md-7 ul {
            margin: 48px 0 0
        }

        .ourgurantee_section .col-md-7 ul li {
            margin-bottom: 38px;
            font-size: 20px;
            display: flex;
            align-items: center
        ...
        .ourgurantee_section .col-md-7 ul li svg {
            flex: 0 0 20px;
            margin-right: 25px
        }
        ...
        .accordion .card h4 {
            background: url(https://cdn0.iconfinder.com/data/icons/entypo/91/arrow56-512.png) calc(100% - 20px) no-repeat;
        ...
        .cmninrpgebnr .banner-form {
            background: #FFFFFF;
            box-shadow: 0px 2.47387px 27.2125px rgba(0, 0, 0, 0.15);
            border-radius: 38.9634px;
        }
        ...
        @media (max-width: 991px) {
            ...
            .header-main.header-main-2 a.float, .header-main.header-main-2 section#home-content, img.inrbnrlftimg {
                display: none
            }
        ...
        @media (max-width: 767px) {
            .float, .peopletrustsec .selling-process.directionLeft:after, .peopletrustsec .selling-process.directionRight:after {
                display: none
            }
            ...
            .cmninrpgecontent section.wekeepcontentsec .container, .wekeepcontentsec .container, .inrpriceincld_Sec .container {
                padding: 0
            }
        }
   ...
   -->
    ...
    <style>
        ...
        * {
        ...
        .bg-custom {
            background: url(https://www.expatcarbuyers.com/front/images/X1.png) left no-repeat #fff;
        ...
        {
            border: 0.92807px solid #E5E5E5;
            border-radius: 71.1237px;
            background-size: 32px 25px;
            background-position: 3px 9px;
            background-repeat: no-repeat;
        }
                                    ...
                                    <div class="col-12 col-lg-10 p-0">
                                        ...
                                        <div class="row m-0">
                                            ...
                                            <div class="dropdown car_year col-12  col-md-6 col-lg-3">
                                                <select class="modl-year form-control w-100" id="year"
                                            ...
                                            <div class="dropdown  selectmake col-12 col-md-6 col-lg-3">
                                                ...
                                                <select class="form-control w-100" id="brand_val"
                                            ...
                                            <div class="dropdown  car_modal col-12 col-md-6 col-lg-3">
                                                ...
                                                <select class="modl-model form-control  w-100" id="fetched_model"
                    ...
                    <div class="d-md-flex flex-md-column p-4">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="mb-4 d-flex">
                                    ...
                                    <div class="ml-5">
                                        <h5 class="mb-2">Keep in touch</h5>
                            ...
                            <li class="mb-4  d-flex">
                                ...
                                <div class="ml-5">
                                    <h5 class="mb-2">Service Helpline</h5>
                            ...
                            <li class="mb-4 d-flex">
                                ...
                                <div class="ml-5">
                                    <h5 class="mb-2">For Support Mail Us</h5>
