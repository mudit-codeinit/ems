   ...
   -->
    ...
    <style>
        ...
        * {
        ...
        .bg {
            background: url(https://www.expatcarbuyers.com/front/images/Header-Img.svg) bottom left repeat-x #fff;
            background-size: cover
        }
        ...
        .reviewBox:before {
            /*background: url(https://www.expatcarbuyers.com/front/images/quotation-mark.svg) no-repeat;*/
            background-size: cover;
            height: 23px;
            width: 23px;
            left: 20px
...
<div id="app">
            ...
            <div class="row d-lg-none py-2 mr-0">
                ...
                <div class="col-sm-12 col-xs-12 pr-0">
                    ...
                    <ul class="nav navbar float-right pl-0">
                        ...
                        <li class="float-left pl-2 pr-2 mt-2 mb-2 border-right"><a href="tel:+971561774555"><span
                                    class="icon-phone theme-color"></span></a></li>

                        <li class="float-left pl-2 pr-2 mt-2 mb-2 border-right"><a target="_blank"
                        ...
                        <li class="float-left pl-2 pr-0 mt-2 mb-2"><a href="https://goo.gl/maps/ytU29m5AggL8sgJ98"
    ...
    <div class="bg d-block ">
        ...
        <div class="position-absolute w-100 banner-Text ">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 text-center">
                        ...
                        <div class="d-flex align-items-center justify-content-center custom-Height-form flex-column w-100 show-dsk desktop">


                            @if(isset($brand->name))
                            <h1 class="font-weight-bold w-100  h3 mb-5 pb-2">Sell Your {{$brand->name}} in UAE with Expat Car
                                Buyers</h1>
                            @else
                                <h1 class="font-weight-bold w-100  h3 mb-5 pb-2">Sell Any Car in UAE with Expat Car
                                Buyers</h1>
                            @endif

                            <p class="font-mons basic-color w-100 d-none d-md-block  h4 mb-3">Want to SELL A CAR in
                            ...
                            <div class="d-inline-block align-items-center w-100">
                                ...
                                <form id="booking_form_step_1" method="Post" action="{{ url('step-2') }}"
                                      class="form-inline banner-form w-100 shadow py-3 px-2">
                                    ...
                                    <div class="col-12 col-lg-10 p-0">
                                        ...
                                        <div class="row m-0">
                                            ...
                                            <div class="dropdown  car_year col-12  col-md-6 col-lg-3 px-xl-2 mb-3 mb-lg-0">
                                            ...
                                            <div class="dropdown  selectmake  col-12 col-md-6 col-lg-3 px-xl-2 mb-3 mb-lg-0">
                                                ...
                                                <select class="form-control custom-rounded" style="width: 100%;" id="brand_val"
                                                    ...
                                                    <option value="{{ $brand1->name }}" style="padding: 0px;">{{
                                                        $brand1->name }}
                                                    </option>
                                            ...
                                            <div class="dropdown  car_modal col-12 col-md-6 col-lg-3 px-xl-2 mb-3 mb-lg-0">
                                    ...
                                    <div class="d-flex align-items-center m-auto ml-lg-auto"
                                         style="margin-top: 2px !important;">

                                        <div class="pr-xl-2">
                                            <button type="submit"
                                                    class="btn btn-danger custom-rounded text-capitalize book-button myform"
                                                    id="book_appon">book now
                                            </button>
                                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-center custom-Height-form flex-column w-100 show-ph">
                            @if(isset($brand->name))
                            <h1 class="font-weight-bold w-100  h3 mb-3">Sell Your {{$brand->name}} in UAE with Expat Car
                                Buyers</h1>
                            @else
                                <h1 class="font-weight-bold w-100  h3 mb-3">Sell Any Car in UAE with Expat Car
                                Buyers</h1>
                            @endif
                            <!--<h1 class="font-weight-bold w-100  h3 mb-3">Sell Any Car in UAE with Expat Car Buyers</h1>-->

                            <p class="font-mons basic-color w-100  d-md-block  h5 mb-3">Want to SELL A CAR in Dubai ?
                                Fill out the form and sell your car in 30 Minutes
                            </p>

                            <div class="d-inline-block align-items-center w-100">

{{--                                <form id="booking_form_step_2" method="Post" action="{{ url('step-2') }}"--}}
{{--                                      class="form-inline banner-form w-100 shadow py-3 px-2">--}}
...
{{--                                                <select class="modl-year form-control" style="width: 100%;" id="year2"--}}
{{--                                                        name="year" aria-label="year">--}}
...
{{--                                                <select class="form-control" style="width: 100%;" id="brand_val2"--}}
{{--                                                        name="brand_name" aria-label="brand">--}}
...
{{--                                                <select class="modl-model form-control" id="fetched_model2"--}}
{{--                                                        style="width: 100%;" name="model_name" aria-label="model">--}}
...
{{--                                                <input type="tel" name="number" placeholder="Phone Number"--}}
{{--                                                       class="numberinput w-100 form-control" aria-label="Phone Number"--}}
{{--                                                       pattern="[0-9]*"> <!---->--}}
...
{{--                                        <div class="pr-xl-2">--}}
{{--                                            <button type="submit"--}}
{{--                                                    class="btn btn-danger text-capitalize book-button myform"--}}
{{--                                                    id="book_appon2">book now--}}
{{--                                            </button>--}}
{{--                                        </div>--}}
...
{{--                                </form>--}}
                                    ...
                                    <div class="col-12 col-lg-10 p-0">
                                        ...
                                        <div class="row m-0">
                                            ...
                                            <div class="dropdown  car_modal col-12 col-md-6 col-lg-3 px-xl-2 mb-3 mb-lg-0">
                                                ...
                                                <select class="modl-model form-control" id="fetched_model"
                                                        style="width: 100%;" name="model_name" aria-label="model">
                            ...
                            <p class="font-weight-light basic-color opsty-0 w-100  h3 mb-2">UAE's <span
                                    class="theme-color font-weight-bold"> No.1 </span> Car Buying Service</p>

                            <p class="font-mons basic-color w-100 d-none d-md-block  h4">People Trust Us Because We
                                Provide Fast, Easy & Honest Service.</p>
        ...
        <div class="bottom-line">
            ...
            <img class="car" src="{{ asset('front/images/car.svg') }}" alt="car">

            <!--<img class="car" src="{{ asset('front/images/car.webp?v=1') }}" alt="car" onerror="this.onerror=null; this.src='{{ asset('front/images/car.svg') }}'">-->
    ...
    <div id="home-content">
        ...
        <section class="supportMail py-4">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <h3 class="font-weight-light text-white text-center mb-0">We Guarantee to Beat Any Other
                            Quote</h3>
        ...
        <div class="container py-3">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    ...
                    <h2 class="font-weight-light mb-5">What people are saying<span class="font-weight-bold theme-color">?</span>
                    </h2>
                        ...
                        <div class="carousel-inner">
                                    ...
                                    <div class="col-lg-4 d-lg-flex flex-lg-column mb-lg-0 mb-5" id="slide1">
                                        ...
                                        <div class="bg-white shadow userReview py-4 px-5 mb-5 h-100">
                                            ...
                                            <div class="ml-3 reviewBox">
                                                ...
                                                <i>Amazing service. If u want to experience the hassle free way of
                                                    selling car, this is the best place to go. Been to other companies
                                                    in past and I must say their service is exeptional.. cheers</i>
                                        ...
                                        <div class="userReview-details d-inline-flex w-100 pl-4">
                                            ...
                                            <div class="userName">
                                                ...
                                                <!--<img src="{{ asset('front/images/star.svg') }}" width="18px" alt="star"/>-->

                                                <img src="{{ asset('front/images/star.webp?v=1') }}" width="18"
                                                     alt="star"
                                                     onerror="this.onerror=null; this.src='{{ asset('front/images/star.svg') }}'">
                                    ...
                                    <div class="col-lg-4 d-lg-flex flex-lg-column mb-lg-0 mb-5">
                                        ...
                                        <div class="bg-white shadow userReview py-4 px-5 mb-5 h-100">
                                            ...
                                            <div class="ml-3 reviewBox">
                                                ...
                                                <i>Great service! Sold my car within 30 minutes and received a good
                                                    price including helping to settle the loan on my car.</i>
                                    ...
                                    <div class="col-lg-4 d-lg-flex flex-lg-column">
                                        ...
                                        <div class="bg-white shadow userReview py-4 px-5 mb-5 h-100">
                                            ...
                                            <div class="ml-3 reviewBox">
                                                ...
                                                <i>I visited several car buying companies in same area but Expat car
                                                    buyers offered the most competitive prices whilst also offering a
                                                    comprehensive and professional service to enable a smooth
                                                    transaction. Great customer service. Would highly recommend</i>
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 d-lg-flex flex-lg-column mb-lg-0 mb-5" id="slide2">

                                        <div class="bg-white shadow userReview py-4 px-5 mb-5 h-100">

                                            <div class="ml-3 reviewBox">

                                                <i>Highly recommend selling any car with the Expat Car Buyers. Fast,
                                                    genuine service. Very helpful guys. My experience was great and
                                                    wouldn’t go to any other place in Dubai.</i>
                                    ...
                                    <div class="col-lg-4 d-lg-flex flex-lg-column mb-lg-0 mb-5">
                                        ...
                                        <div class="bg-white shadow userReview py-4 px-5 mb-5 h-100">
                                            ...
                                            <div class="ml-3 reviewBox">
                                                ...
                                                <i>It was very easy as in one stop shop.Transfer of car and cash payment
                                                    on the spot. The whole thing took under 30 mins and that's what I
                                                    needed. Thank you guys.</i>
                                    ...
                                    <div class="col-lg-4 d-lg-flex flex-lg-column">
                                        ...
                                        <div class="bg-white shadow userReview py-4 px-5 mb-5 h-100">
                                            ...
                                            <div class="ml-3 reviewBox">
                                                ...
                                                <i>Could sell my car in very short time and got a fair price. Thank you
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 d-lg-flex flex-lg-column mb-lg-0" id="slide3">
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 d-lg-flex flex-lg-column mb-lg-0" id="slide4">
    ...
    <!--<section class="simpleFastProfitable py-5">-->

    <!--    <div class="container py-3">-->

    <!--        <div class="col-md-12 mx-auto px-lg-5 px-0">-->

    <!--            <h2 class="font-weight-bolder">Why Choose Us to Sell Any Car?</h2>-->

    <!--            <p class="f-medium font-mons font-18">-->


    <!--                We specialize in buying used cars! Our company's goal is to assist you in selling your vehicle in a-->
    <!--                fast, reasonable, and simple manner. We've been in the automotive industry for many years and we-->
    <!--                provide outstanding service while still providing excellent value for our customers' used cars.-->
    ...
    <!--                ● Paying to advertise to sell your car in UAE.<br>-->

    <!--                ● Strangers coming to your house for a viewing and a test drive.<br>-->

    <!--                ● Leaving your vehicle on the market for months as its value plummets.<br>-->

    <!--                ● Keeping up with your car's repair and insurance payments as you wait for it to be sold.<br><br>-->


    <!--                You can sell your car in 30 minutes and walk away with cash in your pocket with our hassle-free-->
    <!--                service.-->
    ...
    <section class="mt-5 subscribeNewsletter position-relative">
        ...
        <div class="fluid-container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-md-flex bg-light-theme flex-md-column p-4">
                        
                        <div class="footer-abt custom ml-5">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <img class="mr-4" src="{{ asset('front/images/map-marker-outline.webp') }}" alt="map-marker"
                                 onerror="this.onerror=null; this.src='{{ asset('front/images/map-marker-outline.svg') }}'">
    
    
                                    <div>
                                        <h5 class="font-weight-bold mb-2">Keep in touch</h5>
                                        <span>Near FAB Metrostation, <br>Al Asmawi Building, Sheikh Zayed Road,<br> office No. G17 - Dubai - United Arab Emirates</span>
                                    </div>
                        ...
                        <span>
                            ...
                            <img class="mr-4" src="{{ asset('front/images/phone.webp') }}" alt="phone"
                                 onerror="this.onerror=null; this.src='{{ asset('front/images/phone.svg') }}'">

                        </span>

                                <div>
                                    <h5 class="font-weight-bold mb-2">Service Helpline</h5>
                        ...
                        <span>
                            ...
                            <img class="mr-4" src="{{ asset('front/images/email-outline.webp') }}" alt="email outline"
                                 onerror="this.onerror=null; this.src='{{ asset('front/images/email-outline.svg') }}'">

                        </span>

                                <div>
                                    <h5 class="font-weight-bold mb-2">For Support Mail Us</h5>
                        ...
                        <!--<h3 class="font-weight-light mb-3 text-white">Subscribe our Newsletter?</h3>-->

                        <!-- Begin Mailchimp Signup Form -->

                        <!--<div id="mc_embed_signup">-->

                        <!--    <form action="https://expatcarbuyers.us20.list-manage.com/subscribe/post?u=bb130dc27c4d426571a7d2056&amp;id=6a921b8a53"-->
                        <!--          method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form"-->
                        <!--          class="validate" rel="noopener" target="_blank" novalidate>-->
                        ...
                        <!--                       class="required email form-control sign-up mb-3 border-0 h-auto py-3"-->
                        <!--                       placeholder="Email address" id="mce-EMAIL" required aria-label="Email">-->
                        ...
                        <!--                    type="text" name="b_bb130dc27c4d426571a7d2056_6a921b8a53" tabindex="-1"-->
                        <!--                    value=""></div>-->

                        <!--            <div class="clear"><input type="submit" value="Subscribe" name="subscribe"-->
                        <!--                                      id="mc-embedded-subscribe"-->
                        <!--                                      class="btn btn-dark signButton text-uppercase"></div>-->
                ...
                <div class="iframe-map position-absolute">

                    <iframe loading="lazy"
                            src="//www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3612.283477175634!2d55.203038314418016!3d25.12610528392928!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6b44e5d599e5%3A0x5ef0fe7dd34ca4bc!2sExpat+Car+Buyers+UAE!5e0!3m2!1sen!2sin!4v1543578314255"
                            height="495" style="border:0; width:100%" aria-label="map" allowfullscreen></iframe>
    ...
    <section class="footer pt-5 mt-5 bg-light-theme">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2  col-6 col-sm-4 mb-3 mb-lg-0">
                                                ...
                                                <ul class="list-unstyled brand-list">
                                                    ...
                                                    <li><a href="{{ url('sell-bugatti') }}">Sell Your Bugatti</a>
                                                    </li>

                                                    <li><a href="{{ url('sell-ferrari') }}">Sell Your Ferrari</a>
                                                    </li>

                                                    <li><a href="{{ url('sell-infiniti') }}">Sell Your Infiniti</a>
                                                    </li>

                                                    <li><a href="{{ url('sell-land-rover') }}">Sell Your Land
                                                            Rover</a></li>
                                            ...
                                            <div class="col-lg-2 col-6  col-sm-4 mb-3 mb-lg-0">
                                                ...
                                                <ul class="list-unstyled brand-list">
                                                    ...
                                                    <li><a href="{{ url('sell-alfa-romeo') }}">Sell Your Alfa
                                                            Romeo</a></li>
                                                    ...
                                                    <li><a href="{{ url('sell-mcLaren') }}">Sell Your McLaren</a>
                                                    </li>

                                                    <li><a href="{{ url('sell-peugeot') }}">Sell Your Peugeot</a>
                                                    </li>
                                            ...
                                            <div class="col-lg-2 col-6 col-sm-4 mb-3 mb-lg-0">
                                                ...
                                                <ul class="list-unstyled brand-list">
                                                    ...
                                                    <li><a href="{{ url('sell-aston-martin') }}">Sell Your Aston
                                                            Martin</a></li>

                                                    <li><a href="{{ url('sell-cadillac') }}">Sell Your Cadillac</a>
                                                    </li>
                                                    ...
                                                    <li><a href="{{ url('sell-lincoln') }}">Sell Your Lincoln</a>
                                                    </li>

                                                    <li><a href="{{ url('sell-mercedes-benz') }}">Sell Your
                                                            Mercedes-Benz</a></li>

                                                    <li><a href="{{ url('sell-pontiac') }}">Sell Your Pontiac</a>
                                                    </li>
                                            ...
                                            <div class="col-lg-2  col-6 col-sm-4 mb-3 mb-lg-0">
                                                ...
                                                <ul class="list-unstyled brand-list">
                                                    ...
                                                    <li><a href="{{ url('sell-chevrolet') }}">Sell Your
                                                            Chevrolet</a></li>
                                                    ...
                                                    <li><a href="{{ url('sell-porsche') }}">Sell Your Porsche</a>
                                                    </li>
                                            ...
                                            <div class="col-lg-2  col-6 col-sm-4 mb-3 mb-lg-0">
                                                ...
                                                <ul class="list-unstyled brand-list">
                                                    ...
                                                    <li><a href="{{ url('sell-bentley') }}">Sell Your Bentley</a>
                                                    </li>

                                                    <li><a href="{{ url('sell-chrysler') }}">Sell Your Chrysler</a>
                                                    </li>
                                                    ...
                                                    <li><a href="{{ url('sell-maserati') }}">Sell Your Maserati</a>
                                                    </li>

                                                    <li><a href="{{ url('sell-mitsubishi') }}">Sell Your
                                                            Mitsubishi</a></li>

                                                    <li><a href="{{ url('sell-renault') }}">Sell Your Renault</a>
                                                    </li>

                                                    <li><a href="{{ url('sell-volkswagen') }}">Sell Your
                                                            Volkswagen</a></li>
                                            ...
                                            <div class="col-lg-2  col-6 col-sm-4  mb-3 mb-lg-0">
                                                ...
                                                <ul class="list-unstyled brand-list">
                                                    ...
                                                    <li><a href="{{ url('sell-hyundai') }}">Sell Your Hyundai</a>
                                                    </li>

                                                    <li><a href="{{ url('sell-lamborghini') }}">Sell Your
                                                            Lamborghini</a></li>

                                                    <li><a href="{{ url('sell-maybach') }}">Sell Your Maybach</a>
                                                    </li>

                                                    <li><a href="{{ url('sell-nissan') }}">Sell Your Nissan</a></li>

                                                    <li><a href="{{ url('sell-rolls-royce') }}">Sell Your Rolls
                                                            Royce</a></li>
                                ...
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="footer-abt">
                                            ...
                                            <p>Many people would just call us a car buying company, but that’s just
                                                half of the story. Expat Car Buyers was
                                        ...
                                        <div class="footer-social-global">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="https://www.facebook.com/ExpatCarBuyers/"
                                                       target="_blank" rel="noopener">

                                                        <img src="{{ asset('images/facebook.webp') }}"
                                                             alt="facebook"
                                                             onerror="this.onerror=null; this.src='{{ asset('images/facebook.svg') }}'">
                                                ...
                                                <li><a href="https://www.instagram.com/expatcarbuyers/"
                                                       target="_blank" rel="noopener">
        ...
        <div class="row py-3 m-0 footer-bottom">
            ...
            <div class="col-md-6 text-center text-md-right">j
    ...
    <a href="#" class="go-to-top font-mons" id="go-to-top" style="">
        ...
        <!--<img src="{{ asset('front/images/arrow.png') }}" alt="arrow" width="18px">-->

        <img src="{{ asset('front/images/arrow.webp?v=1') }}" alt="arrow" width="18"
             onerror="this.onerror=null; this.src='{{ asset('front/images/arrow.png') }}'">
