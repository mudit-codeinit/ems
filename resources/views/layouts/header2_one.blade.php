...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600&family=Open+Sans:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
                   ...
                   <div class="row">
                      ...
                      <div class="col-lg-3 col-9">
                        ...
                        <a href="/" class="d-inline-block logo">
                            ...
                            <img src="{{ asset('front/images/logo.webp') }}" alt="expatcarbuyers" class="img-fluid logocompany" onerror="this.onerror=null; this.src='{{ asset('front/images/logo.png') }}'">
                      ...
                      <div class="col-lg-9 col-3 text-right">
                        ...
                        <button class="btn btn-danger ml-3 px-3 py-2 btn-phone d-none d-lg-inline-block"><a href="tel:+971561774555" class="header-phone">
                            ...
                            <!--<img src="{{ asset('front/images/phone.png') }}" alt="phone" class="mr-2" />--> +971 56 1774555</a></button>
                ...
                <div class="col-sm-12 col-xs-12 pr-0">
                    ...
                    <ul class="nav navbar float-left pr-0" style="display: none;">
                     ...
                     <ul class="nav navbar float-right pl-0">
                        ...
                        <li class="float-left pl-2 pr-2 mb-2 border-right"><a href="tel:+971561774555"><span class="icon-phone theme-color"></span></a></li>

                        <li class="float-left pl-2 pr-2 mb-2 border-right"><a target="_blank" rel="noopener noreferrer" href="https://wa.me/+971561774555">
                        ...
                        <li class="float-left pl-2 pr-0 mb-2"><a href="https://goo.gl/maps/ytU29m5AggL8sgJ98" target="_blank" rel="noreferrer"><span class="icon-location-pin theme-color"></span></a></li>
...
<i class="fa fa-phone my-float"></i>
		...
		<div class="banner cmninrpgebnr position-relative">
			<img src="https://www.expatcarbuyers.com/images/Header-Shape.svg" alt="image" class="inrbnrlftimg" loading="lazy">
			<div class="container">
				<div class="row">
				...
				<div class="col-lg-5">
					<div class="banner-form position-relative">
							<h1 class="text-center semibold mb-4 pb-1 font-23">Sell Any Car to <span class="theme-color semibold">EXPATCARBUYERS</span> in 30 minutes</h1>
						<form id="booking_form_step_1" method="Post" action="{{ url('step-2') }}" >
							...
							<div class="form-group bannr_frm_btn d-inline-block">
								<button type="submit" class="d-block w-100 border-0 font-weight-bold btn-primary myform">
								EVALUATE YOUR CAR
								</button>
							</div>
						</form>
						<a href="tel:+971561774555" class="inrpgebnrphoneicon">
							...
							<path d="M4.13406 1.3371L5.95944 0.736847C7.67117 0.174981 9.49995 1.08409 10.2328 2.86042L11.6918 6.39913C12.3262 7.9399 11.9734 9.75288 10.8198 10.8801L7.60501 14.0175C7.80349 15.895 8.41761 17.7429 9.44566 19.5611C10.4219 21.3202 11.7314 22.86 13.2966 24.0892L17.1577 22.7631C18.6201 22.2623 20.2148 22.8398 21.1105 24.1956L23.2022 27.354C24.2455 28.9314 24.0572 31.1055 22.7628 32.4422L21.3768 33.8747C19.9959 35.3003 18.0229 35.8186 16.1993 35.2323C11.8903 33.8503 7.93242 29.748 4.31897 22.9253C0.700431 16.0922 -0.577001 10.2921 0.488374 5.5319C0.936238 3.52873 2.32224 1.93212 4.13406 1.3371Z" fill="white"/>
							</svg></a>
					</div>
				</div>
				</div>
			...
			<section class="supportMail py-4 hmbnrbtmsec">
			 <div class="container">
				<div class="row">
				   ...
				   <div class="col-md-12">
							<h3 class="text-white text-center mb-0">Evaluate Any Car, Get Highest Quote and Sell Any Car Instantly</h3>
				   </div>
...
<!--      </section>-->
               ...
               <div class="footer-social-global">
                   ...
                   <ul>
					    ...
					    <li><a href="https://www.facebook.com/ExpatCarBuyers/" target="_blank" rel="noopener">
					        ...
					        <img src="{{ asset('images/facebook.webp') }}" alt="facebook" onerror="this.onerror=null; this.src='{{ asset('images/facebook.svg') }}'"/>

					        </a></li>

						<li><a href="https://twitter.com/expatcarbuyers" target="_blank" rel="noopener">

						    <img src="{{ asset('images/twitter.webp') }}" alt="twitter" onerror="this.onerror=null; this.src='{{ asset('images/twitter.svg') }}'"/>

						    </a></li>

						<li><a href="https://www.instagram.com/expatcarbuyers/" target="_blank" rel="noopener">

						    <img src="{{ asset('images/instagram.webp') }}" alt="instagram" onerror="this.onerror=null; this.src='{{ asset('images/instagram.svg') }}'"/>
               ...
               <div class="footer-abt">
                  ...
                  <ul class="list-unstyled">
                     ...
                     <li class="mb-2 d-flex">
                        ...
                        <img class="mr-2" src="{{ asset('front/images/map-marker-outline.webp') }}" alt="map-marker" onerror="this.onerror=null; this.src='{{ asset('front/images/map-marker-outline.svg') }}'"/>
                     ...
                     <li class="mb-2  d-flex">
                        ...
                        <span>
                            ...
                            <img class="mr-2" src="{{ asset('front/images/phone.webp') }}" alt="phone" onerror="this.onerror=null; this.src='{{ asset('front/images/phone.svg') }}'"/>
                     ...
                     <li class="mb-2  d-flex">
                        ...
                        <span>
                            ...
                            <img class="mr-2" src="{{ asset('front/images/email-outline.webp') }}" alt="email outline" onerror="this.onerror=null; this.src='{{ asset('front/images/email-outline.svg') }}'"/>
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-2  col-6 col-sm-4 mb-3 mb-lg-0">
                              ...
                              <ul class="list-unstyled brand-list">
                                 ...
                                 <li><a href="{{ url('sell-land-rover') }}">Sell My Land Rover</a></li>
                           ...
                           <div class="col-lg-2 col-6 col-sm-4 mb-3 mb-lg-0">
                              ...
                              <ul class="list-unstyled brand-list">
                                 ...
                                 <li><a href="{{ url('sell-aston-martin') }}">Sell My Aston Martin</a></li>
                                 ...
                                 <li><a href="{{ url('sell-mercedes-benz') }}">Sell My Mercedes-Benz</a></li>
                           ...
                           <div class="col-lg-2  col-6 col-sm-4 mb-3 mb-lg-0">
                              ...
                              <ul class="list-unstyled brand-list">
                                 ...
                                 <li><a href="{{ url('sell-mitsubishi') }}">Sell My Mitsubishi</a></li>

                                 <li><a href="{{ url('sell-renault') }}">Sell My Renault</a></li>

                                 <li><a href="{{ url('sell-volkswagen') }}">Sell My Volkswagen</a></li>
                           ...
                           <div class="col-lg-2  col-6 col-sm-4  mb-3 mb-lg-0">
                              ...
                              <ul class="list-unstyled brand-list">
                                 ...
                                 <li><a href="{{ url('sell-lamborghini') }}">Sell My Lamborghini</a></li>

                                 <li><a href="{{ url('sell-maybach') }}">Sell My Maybach</a></li>

                                 <li><a href="{{ url('sell-nissan') }}">Sell My Nissan</a></li>

                                 <li><a href="{{ url('sell-rolls-royce') }}">Sell My Rolls Royce</a></li>
                     ...
                     <div class="card-body">
                        ...
                        <ul class="list-unstyled">
                           ...
                           <li class="mb-2  d-flex">
                              ...
                              <img class="mr-2" src="{{ asset('front/images/email-outline.webp') }}" alt="email" onerror="this.onerror=null; this.src='{{ asset('front/images/email-outline.svg') }}'"/>
   ...
   <!--<img src="{{ asset('front2/images/arrow.png') }}" alt="" width="18px">-->
      ...
      <img src="{{ asset('front2/images/arrow.webp') }}" alt="expatcarbuyers" onerror="this.onerror=null; this.src='{{ asset('front/images/logo.png') }}'">
