...
<div id="app">
            ...
            <div class="bg-custom container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 text-center ml-auto">
                        ...
                        <div class="d-flex align-items-center justify-content-center custom-Height-form flex-column w-100 banner-form w-100 shadow mb-4">


                            <h5 class="mb-3">Sell Any Car to <span
                    class="theme-color"> EXPATCARBUYERS </span><br>
                                 in 30 minutes</h5>
    ...
    <div id="home-content">
            ...
            <section class="supportMail py-2">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <!--<h4 class="text-center mb-0">We Guarantee to Beat Any Other-->
                            <!--    Quote</h4>-->
                                                        <h4 class="text-center mb-0">Do you want to sell your car fast? Then you are at the right place! </h4>
