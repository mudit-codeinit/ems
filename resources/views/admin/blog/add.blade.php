...
<section class="content"> 
 <div class="row">
    ...
    <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="POST" action="{{url('admin-blog/store') }}" role="form" enctype="multipart/form-data">
                {{ csrf_field() }}
              <div class="box-body">
                ...
                <textarea id="editor"  class="form-control content" placeholder="Description" name="description">{{old('description')}}</textarea>
                </div>
                <div class="form-group">
